...
export const apiOperations = [
  ...
  {
    operationId: "postApiAuthPassword",
    method: "POST",
    path: "/api/auth/password",
    routeFile: "app/api/auth/password/route.ts",
    tag: "Auth",
    summary: "验证当前密码并修改密码，撤销所有会话",
    authenticated: true,
    request: json("ChangePasswordRequest", changePasswordRequestSchema),
    responses: {
      200: response("ChangePasswordSuccess", apiSuccessSchema(changePasswordResponseSchema)),
      ...failures(400, 401, 403, 409, 413, 415, 429, 500, 503),
    },
  },
  {
    operationId: "postApiAdminUsersIdPassword",
    method: "POST",
    path: "/api/admin/users/{id}/password",
    routeFile: "app/api/admin/users/[id]/password/route.ts",
    tag: "Admin",
    summary: "管理员重置其他用户密码并撤销其所有会话",
    authenticated: true,
    request: json("ResetUserPasswordRequest", resetUserPasswordRequestSchema),
    responses: {
      200: response("ResetUserPasswordSuccess", apiSuccessSchema(resetUserPasswordResponseSchema)),
      ...failures(400, 401, 403, 404, 409, 413, 415, 500, 503),
    },
  },
  {
    ...
    method: "POST",
    path: "/api/auth/login",
    routeFile: "app/api/auth/login/route.ts",
    tag: "Auth",
    summary: "账号密码登录",
    request: json("LoginRequest", loginRequestSchema),
    responses: {
      200: response("LoginSuccess", apiSuccessSchema(loginResponseSchema), 200),
      ...failures(415, 400, 401, 403, 413, 429, 500, 503),
    },
  },
  {
    ...
    method: "GET",
    path: "/api/auth/me",
    routeFile: "app/api/auth/me/route.ts",
    tag: "Auth",
    summary: "获取当前用户、角色和权限",
    authenticated: true,
    responses: {
      200: response("CurrentUserSuccess", apiSuccessSchema(currentUserResponseSchema), 200),
      ...failures(401, 500, 503),
    },
  },
  {
    ...
    authenticated: true,
    responses: {
      200: response("LogoutSuccess", apiSuccessSchema(logoutResponseSchema), 200),
      ...failures(401, 403, 500, 503),
    },
  },
  {
  ...
  },
  {
    ...
    routeFile: "app/api/admin/users/route.ts",
    tag: "Admin",
    summary: "分页搜索用户、角色和权限",
    authenticated: true,
    query: { name: "UserPageQuery", schema: userPageQuerySchema },
    responses: {
      200: response("UserDirectorySuccess", apiSuccessSchema(userDirectorySchema), 200),
      ...failures(400, 401, 403, 500, 503),
    },
  },
  {
    ...
    responses: {
      201: response("UserSuccess", apiSuccessSchema(userSchema), 201),
      ...failures(415, 400, 401, 403, 409, 413, 500, 503),
    },
  },
  {
    operationId: "patchApiAdminUsersId",
    method: "PATCH",
    path: "/api/admin/users/{id}",
    routeFile: "app/api/admin/users/[id]/route.ts",
    tag: "Admin",
    summary: "更新用户",
    authenticated: true,
    request: json("UpdateUserRequest", updateUserRequestSchema),
    responses: {
      200: response("UserSuccess", apiSuccessSchema(userSchema), 200),
      ...failures(415, 400, 401, 403, 404, 409, 413, 500, 503),
    },
  },
  {
    ...
    routeFile: "app/api/admin/roles/route.ts",
    tag: "Admin",
    summary: "查询角色",
    authenticated: true,
    responses: {
      200: response("RoleListSuccess", apiSuccessSchema(z.array(roleSchema)), 200),
      ...failures(401, 403, 500, 503),
    },
  },
  {
    operationId: "postApiAdminRoles",
    method: "POST",
    path: "/api/admin/roles",
    routeFile: "app/api/admin/roles/route.ts",
    tag: "Admin",
    ...
    responses: {
      201: response("RoleSuccess", apiSuccessSchema(roleSchema), 201),
      ...failures(415, 400, 401, 403, 409, 413, 500, 503),
    },
  },
  {
    operationId: "patchApiAdminRolesId",
    method: "PATCH",
    path: "/api/admin/roles/{id}",
    routeFile: "app/api/admin/roles/[id]/route.ts",
    tag: "Admin",
    summary: "更新角色",
    authenticated: true,
    request: json("UpdateRoleRequest", updateRoleRequestSchema),
    responses: {
      200: response("RoleSuccess", apiSuccessSchema(roleSchema), 200),
      ...failures(415, 400, 401, 403, 404, 409, 413, 500, 503),
    },
  },
  {
    operationId: "getApiAdminAuditLogs",
    method: "GET",
    path: "/api/admin/audit-logs",
    routeFile: "app/api/admin/audit-logs/route.ts",
    tag: "Admin",
    summary: "分页搜索审计日志",
    authenticated: true,
    query: { name: "AuditPageQuery", schema: auditPageQuerySchema },
    responses: {
      200: response("AuditListSuccess", apiSuccessSchema(auditPageSchema), 200),
      ...failures(400, 401, 403, 500, 503),
    },
  },
  {
    operationId: "getApiAdminOutboxEvents",
    method: "GET",
    path: "/api/admin/outbox-events",
    routeFile: "app/api/admin/outbox-events/route.ts",
    tag: "Admin",
    summary: "查询 outbox 事件",
    authenticated: true,
    responses: {
      200: response("OutboxListSuccess", apiSuccessSchema(z.array(outboxEventSchema)), 200),
      ...failures(401, 403, 500, 503),
    },
  },
  {
    operationId: "getApiAdminAsyncRuntimeHealth",
    method: "GET",
    path: "/api/admin/async-runtime-health",
    routeFile: "app/api/admin/async-runtime-health/route.ts",
    tag: "Admin",
    summary: "查询异步运行时计划和任务积压",
    authenticated: true,
    responses: {
      200: response("AsyncRuntimeHealthSuccess", apiSuccessSchema(asyncRuntimeHealthSchema), 200),
      ...failures(401, 403, 500, 503),
    },
  },
  {
