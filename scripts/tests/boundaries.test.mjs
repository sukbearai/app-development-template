...
test('package boundary gate rejects builtins and relative cross-layer imports', async () => {
  ...
  try {
    for (const directory of ['scripts', 'apps/web/app', 'apps/web/components', 'apps/web/lib', 'packages/contracts/src', 'packages/database/src', 'packages/server/src']) await mkdir(path.join(fixture, directory), { recursive: true });
