...
test('documentation check detects stale links, recipe order and source/verification mappings', async () => {
  ...
  try {
    ...
    await write('docs/startup-steps.json', JSON.stringify({ install: ['install', '--frozen-lockfile'], dev: ['dev'] }));
    await write('README.md', 'pnpm install --frozen-lockfile\npnpm dev\n[Feature](.agents/skills/verify-pstack-x/features/README.md)');
    ...
    await write('README.md', 'pnpm dev\npnpm install --frozen-lockfile\n[Gone](docs/gone.md)\n`apps/web/gone.mjs`');
