...
[doctor.mjs](scripts/doctor.mjs) verifies the lock owner PID, listening port, checkout and exact hello response before browser checks. Its standalone success confirms identity, not ownership permission.
